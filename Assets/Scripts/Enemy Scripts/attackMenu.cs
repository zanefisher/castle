...
//            UnitController.attackThrowingPrepUnits.Enqueue(UnitController.idleUnits.Dequeue());
...
//        GameObject.Find ("Base").GetComponent<HandController> ().ThrowUnitstoEnemy (destination/*, unitAmount*/);
//        yield return null;
//    }
//}
